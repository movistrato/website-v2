  ...
  return (
    <div className="relative w-full h-28 my-3 flex flex-col justify-center items-center select-none overflow-hidden">
      ...
      <svg viewBox="0 0 240 76" className="w-full h-full max-w-[250px] overflow-visible relative z-10" fill="none">
        ...
        {/* Node 2: Adaptive Pivot */}
        <circle cx="140" cy="32" r="3.5" fill="#D9A62E" />
        <circle cx="140" cy="32" r="6.5" stroke="#D9A62E" strokeWidth="1" strokeOpacity="0.5" className="animate-ping" />
  ...
  return (
    <div className="relative w-full h-28 my-3 flex flex-col justify-center items-center select-none overflow-hidden">
      ...
      <svg viewBox="0 0 240 76" className="w-full h-full max-w-[250px] overflow-visible relative z-10" fill="none">
        ...
        {/* Native Pulse Signal (zero latency spikes) */}
        <motion.path
        ...
        {/* Precision hardware corner markers */}
        <circle cx="50" cy="18" r="2.5" fill="#D9A62E" />
        <circle cx="105" cy="18" r="2.5" fill="#D9A62E" />
        <circle cx="160" cy="18" r="2.5" fill="#D9A62E" />
        <circle cx="215" cy="18" r="2.5" fill="#D9A62E" />

        {/* Bottom Hardware Architecture Layer Strip */}
        <rect x="25" y="66" width="190" height="6" rx="1" fill="currentColor" fillOpacity="0.08" />
        <rect x="75" y="66" width="90" height="6" rx="1" fill="#D9A62E" fillOpacity="0.25" />
      </svg>
